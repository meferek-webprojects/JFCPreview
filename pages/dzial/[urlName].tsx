            ...
            { department.subcategory ? 
                <MdContainer>
                    ...
                    <div className="flex flex-wrap text-center gap-2 justify-center">
                        ...
                        { department.name == "Rolnictwo" ? 
                        <>
                            <a href={`/system-napowietrzania-gnojowicy`} className="group">
                                <div className="w-[170px] border-[8px] border-blue-500 bg-blue-500 group-hover:bg-blue-300 group-hover:border-blue-300 aspect-square flex transition-all duration-300 easy-in-out">
                                    <h5 className="my-auto mx-auto font-prometobold uppercase text-white group-hover:scale-[0.9] transition-all duration-300 easy-in-out">System napowietrzania gnojowicy</h5>
                                </div>
                            </a>
                            <a href={`/hydrauliczny-zgarniacz-obornika`} className="group">
                                <div className="w-[170px] border-[8px] border-blue-500 bg-blue-500 group-hover:bg-blue-300 group-hover:border-blue-300 aspect-square flex transition-all duration-300 easy-in-out">
                                    <h5 className="my-auto mx-auto font-prometobold uppercase text-white group-hover:scale-[0.9] transition-all duration-300 easy-in-out">Hydrauliczny zgarniacz obornika</h5>
                                </div>
                            </a>
                        </>
