...
const DepartmentsIcon = ({ icon, title, desc, href }: Props) => {
    return (
        <Link href={ href }>
            <div className="flex flex-col sm:flex-row group hover:cursor-pointer h-60 w-full xl:w-1/2 mb-4 sm:mb-8 mx-4 md:mx-16 lg:mx-32 xl:mx-0">
                <div className="bg-blue-500 h-1/2 sm:h-3/5 lg:h-4/5 2xl:h-full aspect-square self-center flex transition-transform easy-in-out duration-300 xl:ml-4" style={{ clipPath: "polygon(50% 0%, 100% 50%, 50% 100%, 0% 50%)" }}>
